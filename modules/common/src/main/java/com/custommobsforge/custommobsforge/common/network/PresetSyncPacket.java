...
public class PresetSyncPacket {
    ...
    public PresetSyncPacket(String name, float health, double speed, float sizeWidth, float sizeHeight, String modelName, String textureName, String animationName) {
        this.name = name;
        this.health = health;
        this.speed = speed;
